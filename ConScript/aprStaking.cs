...
namespace Monad_TestNet_Script
{
    ...
    public class aprstaking
    {
        ...
        private readonly string _contractAddress = "0xb2f82D0f38dc453D596Ad40A37799446Cc89274A"; 
        ...
        public async Task TestAsync()
        {
            ...
            // 4. 参数准备
            BigInteger[] requestIds = new BigInteger[] { 3563750 };  
            string receiver = _web3.Eth.TransactionManager.Account.Address;  
