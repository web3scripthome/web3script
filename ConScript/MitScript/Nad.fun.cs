...
namespace NadFun.Api
{
    ...
    public class NadFunApiClient
    {
        ...
        /// 初始化NadFun API客户端
        /// </summary>
        /// <param name="baseUrl">API基础URL，默认为测试网URL</param>
        ...
        //        PropertyNamingPolicy = null, // 不使用CamelCase，保持API原始的属性名
        //        NumberHandling = JsonNumberHandling.AllowReadingFromString, // 允许从字符串读取数值
