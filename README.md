...
⚡ 目前免费放出两个脚本：没有任务功能限制  `Monad` 与 `PharosNetwork`
...
- Windows 10 及以上系统
- 程序包下载[web3script_windowsX86](https://github.com/web3scripthome/web3script/releases/download/v2/web3script_windowsX86.zip)
